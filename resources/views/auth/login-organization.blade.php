...
<head>
    ...
    <title>Organization Login - AmikomEventHub</title>
...
<body class="bg-indigo-900 text-white min-h-screen flex items-center justify-center p-6">
    <div class="max-w-md w-full bg-white text-slate-900 rounded-[2rem] p-8 shadow-2xl">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-black">Organization Login</h1>
        ...
        <form action="{{ route('organization.login.post') }}" method="POST" class="space-y-6">
            @csrf
            <div>

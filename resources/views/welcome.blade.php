    ...
    <section id="events" class="max-w-7xl mx-auto px-6 py-20">
        <div class="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
            <div class="text-center md:text-left">
                <h2 class="text-3xl font-extrabold mb-2 text-slate-900 tracking-tight">Event Terdekat</h2>
            ...
            <div class="flex flex-wrap justify-center gap-3">
                ...
                @foreach($categories as $cat)
                    ...
                    {{ request('category') == $cat->slug 
                            ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-200 -translate-y-1' 
                            : 'bg-white border border-slate-200 text-slate-600 hover:border-indigo-600 hover:text-indigo-600 hover:shadow-md' 
                    }}">
                        {{ $cat->name }}
                    </a>
                @endforeach
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="text-center mb-14">
                ...
                <p class="text-slate-500 max-w-2xl mx-auto">
                    ...
                    dalam penyelenggaraan event, seminar, workshop, dan konser.
                </p>
            </div>

...
@section('page_subtitle','Selamat datang di dashboard organisasi')
...
<div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
    <div class="p-8 border-b flex justify-between items-center">
        ...
        <a href="{{ route('organization.transactions.index') }}" class="text-indigo-600 font-bold hover:underline">Lihat Semua</a>
    </div>
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50 transition">
                    ...
                    <td class="px-8 py-6 text-sm text-slate-500">{{ $trx->created_at->format('d M y - H:i') }}</td>

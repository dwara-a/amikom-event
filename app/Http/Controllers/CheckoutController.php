...
class CheckoutController extends Controller
{
    ...
    public function option(Event $event)
    {
        return view('checkout.option', compact('event'));
    }
    ...
    public function store(Request $request, Event $event)
    {
        ...
        // 3.5. Jika event GRATIS (Rp 0) — bypass seluruh alur Midtrans
        if ($event->price == 0) {
        ...
        // 4. Merekam Transaksi ke Database (berbayar)
        $transaction = Transaction::create([
            'customer_id' => auth()->check() ? auth()->id() : null,
    ...
    public function success($order_id)
    {
        ...
        // Jika transaksi sudah success (free event bypass), langsung tampilkan halaman sukses
